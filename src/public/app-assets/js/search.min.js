...
$(function() {
    ...
    $(".search-sm-close").on("click", function() { searchBoxSm.val(""), searchBoxSm.blur(), searchListLi.remove(), searchList.addClass("display-none"), contentOverlay.hasClass("show") && contentOverlay.removeClass("show") }), contentOverlay.on("click", function() { searchListLi.remove(), contentOverlay.removeClass("show"), searchSm.hide(), searchBoxSm.val(""), searchList.addClass("display-none"), $(".search-input-sm .search-box-sm, .header-search-input").val("") }), $(".header-search-wrapper .header-search-input, .search-input-sm .search-box-sm").on("keyup", function(e) {
        ...
        if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            27 == e.keyCode && (contentOverlay.removeClass("show"), s.val(""), s.blur());
            ...
            if ($("ul.search-list li").remove(), "" != t) {
                ...
                $.getJSON("../../../app-assets/data/" + a + ".json", function(e) {
                    for (var s = 0; s < e.listItems.length; s++)(0 == e.listItems[s].name.toLowerCase().indexOf(t) && n < 4 || 0 != e.listItems[s].name.toLowerCase().indexOf(t) && -1 < e.listItems[s].name.toLowerCase().indexOf(t) && n < 4) && (i += '<li class="auto-suggestion ' + (0 === n ? "current_item" : "") + '"><a class="collection-item" href=' + e.listItems[s].url + '><div class="display-flex"><div class="display-flex align-item-center flex-grow-1"><span class="material-icons" data-icon="' + e.listItems[s].icon + '">' + e.listItems[s].icon + '</span><div class="member-info display-flex flex-column"><span class="black-text">' + e.listItems[s].name + '</span><small class="grey-text">' + e.listItems[s].category + "</small></div></div></div></a></li>", n++);
                    "" == i && "" == c && (c = $("#search-not-found").html());
                    var a = $("#page-search-title").html(),
                        r = $("#default-search-main").html();
                    l = a.concat(i, c, r), $("ul.search-list").html(l)
                })
            } else contentOverlay.hasClass("show") && (contentOverlay.removeClass("show"), searchList.addClass("display-none"))
        }
        $(".header-search-wrapper .current_item").length && (searchList.scrollTop(0), searchList.scrollTop($(".search-list .current_item:first").offset().top - searchList.height())), $(".search-input-sm .current_item").length && (searchListSm.scrollTop(0), searchListSm.scrollTop($(".search-list-sm .current_item:first").offset().top - searchListSm.height()))
